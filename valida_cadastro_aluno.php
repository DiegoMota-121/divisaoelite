<?php
    ...
    if(!($usuario->senha == $usuario->confirmar_senha)){
        header('Location: cadastro_aluno.php?cadastro=error1');
        die;
    }
    ...
    if(strlen($usuario->senha) < 9){
        header('Location: cadastro_aluno.php?cadastro=error2');
        die;
    }
    ...
    if($email_existentes->num_rows > 0){
        header('Location: cadastro_aluno.php?cadastro=erro3');
        die;
    }
    ...
    if($usuario_sql){
        header('Location: login_aluno.php?cadastro=success');
        die;
    } else {
        header('Location: login_aluno.php?cadastro=error4');      
        die;
    }
